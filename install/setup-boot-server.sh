...
say "מגדיר dnsmasq (הבסיס בלבד; TFTP ו-DHCP נכתבים על ידי השרת, #1013)"
...
# ‏#1013: enable-tftp ו-tftp-root אינם כאן עוד — הם בקובץ שהשרת מרנדר
# (imagectl-dhcp.conf, server/dhcp.py:render), כי זה המתג של פורט 69 בדף
# הפורטים, ו-dnsmasq (שקורא את /etc/dnsmasq.d במצטבר) אינו יודע לבטל
# אפשרות מקובץ אחר. השרת כותב אותן בעלייה כשרשת ההפצה מוגדרת. שורה
# פעילה כאן = אין מתג, וזה מה שהקונסולה תציג.
