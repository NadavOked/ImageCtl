...
|---|---|---|---|---|
| ‏HTTP — תפריט GRUB, קרנל, initrd, ‏API של הסוכן, משיכת אימג' | `8080/tcp` | `80` / `443` | — | http בלבד — ה-GRUB החתום נבנה בלי TLS |
| **‏HTTPS — הקונסולה/הניהול** | `8081/tcp` | `80` / `443` | — | **תעודה חתומה-עצמית, HTTP אינו מוגש**; על כרטיס הניהול בלבד (‏#703). ראו למטה |
| ‏HTTP — קיוסק (מסך התחנה) | `8082/tcp` | — | — | וילן ההפצה |
| ‏mTLS — הערוץ הבין-שרתי (משניים) | `8443/tcp` | — | — | רק על שרת משני |
